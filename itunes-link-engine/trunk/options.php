...
<div class="wrap">
  ...
  <form method="post" action="options.php" id="connect-gr-api-form" class="<?php if (get_option('georiot_tsid') != '') print 'gr-status-loaded-tsid'; ?>">
    ...
    <div id="gr-step-2" class="gr-step-area <?php if (get_option('georiot_tsid') != '') print 'gr-step-complete'; ?>">
      ...
      <div class="gr-step-info">
          <strong>Gain Insight with traffic reports.</strong> <a href="http://www.georiot.com/wordpress-plugin/itunes-sign-up">Create a free GeoRiot account</a> and enter your API keys here.
    ...
    <div class="faq">
      ...
      <p><strong>No,</strong> you do NOT need a GeoRiot account to use the iTunes Link Engine plugin.
        As soon as you download the free plugin, all of your links will be automatically localized,
        and your customers will be routed to the correct product in their local storefront.  However,
        if you want to add your affiliate parameters, you will need a GeoRiot account.
      </p>
      ...
      <ol>
        <li>If you do not have a GeoRiot account, <a href="http://www.georiot.com/Wordpress-Plugin/iTunes-Sign-Up">create a free account</a>.</li>
      ...
      <ol>
        <li>Add your PHG affiliate parameter to your GeoRiot dashboard.  Instructions on how to do this can be found <a href="http://support.georiot.com/support/solutions/articles/71867-add-existing-affiliate">here</a>.
        <br><strong>Note:</strong> If you’ve already done this within your existing GeoRiot account, you do not need to add your parameter again.
        </li>
        <li> You’re all set! You’ll start earning commissions from anything purchased from iTunes.</li>
        <p>
          <strong>Please Note:</strong> If you are already using affiliated links on your website, they will not remain affiliated if you use the iTunes Link Engine Plugin.  In order to affiliate your links, you must <a href="http://www.georiot.com/Wordpress-Plugin/iTunes-Sign-Up">sign up for a GeoRiot account</a> and add your affiliate parameters to the dashboard.  Once you have done this, and connected your account using the API keys, each of your links will be automatically affiliated.
        </p>
      </ol>
      ...
      <p>At GeoRiot, clicks are our currency, and we earn money the way you do – through international affiliate programs. With our “<a href="http://www.georiot.com/our-solution/pay-with-clicks">Click Share</a>” payment model, you simply share a maximum of 15% of your international clicks with GeoRiot. We then affiliate those clicks with our affiliate parameter instead.
      </p>
