...
To earn affiliate commissions, you first need to [create a free GeoRiot account](http://www.georiot.com/Wordpress-Plugin/iTunes-Sign-Up), then connect it to your plugin (detailed instructions can be found in the [FAQ](https://wordpress.org/plugins/itunes-link-engine/faq/).  Next, add your PHG affiliate ID to your GeoRiot Dashboard. Once your parameter has been added, the iTunes Link Engine will automatically add your affiliate ID to each link within your WordPress site. 

*Note:* You don’t need to create a GeoRiot account, nor add your affiliate parameters to use this plugin. If you’re only interested in giving your international audience a better experience, this plugin can still be used to make sure each click gets redirected to their local storefront. 
...
At GeoRiot, clicks are our currency, and we earn money the way you do – through international affiliate programs. With our ["Click Share”](http://www.georiot.com/our-solution/pay-with-clicks) payment model, you simply share a maximum of 15% of your international clicks with GeoRiot. We then affiliate those clicks with our affiliate parameter instead.
...
The iTunes Publisher Studio tool is unfortunately not compatible with this version of the iLE plugin.
