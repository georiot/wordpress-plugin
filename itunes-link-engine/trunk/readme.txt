...
Tags: itunes, associates, affiliate, universal, localize, link, engine, monetization, globalize, georiot, ale, javascript
...
Automatically localize and affiliate iTunes product links to improve user experience, increase conversions and earn global commissions.


== Description ==

The iTunes Link Engine plugin is the easiest way to convert all iTunes links within your
WordPress site into affiliated links that work across all [iTunes storefronts](https://affiliate-program.iTunes.com/gp/associates/help/t22/a13).  By "Localizing"
...
international affiliate commissions that you deserve.
...
The iTunes Link Engine plugin uses GeoRiot’s [patented](https://www.google.com/patents/US8838767) five-step algorithm to dig deep into iTunes’s stores to find the best possible result.  This algorithm uses the metadata available from each product to match across storefronts and ensure that the user is sent to the most relevant product. So instead of sending your users to blank search results, we guarantee the best possible user experience.
...
As soon as the plugin is installed, your iTunes links are instantly localized every time a user loads the page.  Even if you add new links to your WordPress site, each will be automatically converted without any additional work from you. Nothing else is needed on your part.

= How do I earn commissions from my links? =

To earn affiliate commissions, you first need to [create a free GeoRiot account](http://www.georiot.com/wordpress-plugin/sign-up), and connect it to your plugin (detailed instructions can be found in the [FAQ](https://wordpress.org/plugins/iTunes-link-engine/faq/)).  Next, add and manage your affiliate tracking parameters for each of the iTunes Associates programs you’ve signed up for within the GeoRiot Dashboard. Once your parameters are added, the iTunes Link Engine will automatically add the correct affiliate ID per country for each click.
...
= Key Features: =
* Automatic localization and translation of all iTunes product links based off a visitor’s location.
* Maximize revenue by earning commissions from all of the iTunes Associates programs.
...
* No need to sign up for an iTunes Developer account or apply for any of iTunes’s APIs or web tools.
...
* Most plugins for iTunes links simply try to match based on ASIN (product ID) across foreign storefronts. The iTunes Link Engine uses a patented algorithm to get your users to the best possible destination.
* This in turn helps to both increase conversions and commissions, as well improve the user experience for your audience.
* Completely free support from the GeoRiot team for the Associate’s Programs.
...
GeoRiot only makes money when we help you earn more money.
...
1. Install the iTunes Link Engine plugin using the WordPress Plugin Installer above.
...
1.  If you haven’t already, sign up for the [iTunes Associates programs](http://associates.iTunes.com) you’d like to earn commissions from (instructions on how to sign up can be found on [our site](http://support.georiot.com/support/solutions/articles/3000013792-how-to-sign-up-for-the-iTunes-associates)).
1.  Once approved for the various iTunes Associates programs, jump into your GeoRiot dashboard and click on "Affiliate" tab. Then, click  "Connect an affiliate program" button and paste in your IDs.  Select the appropriate country, then click save.
...
GeoRiot is a link management platform that maximizes your potential iTunes Associates revenue by globalizing and affiliating your iTunes Links.  GeoRiot hopes to change the way online commerce is conducted by providing its clients with intelligent links that automatically route customers to the correct product within their own local storefront.

= Do I need a GeoRiot Account to use this plugin? =

No, you do NOT need a GeoRiot account to use the iTunes Link Engine plugin.  As soon as you install and activate the free plugin, all of your links will be automatically localized, and your customers will be routed to the product in their local storefront.  However, if you want to add your affiliate parameters, you will need a GeoRiot account.
...
1. Add your iTunes Affiliate parameters to your GeoRiot dashboard. Instructions on how to do this can be found [here](http://support.georiot.com/support/solutions/articles/71867-add-existing-affiliate).
...
* **iTunes Publisher Studio:**
The iTunes Publisher Studio tool is unfortunately not compatible with this version of the ALE plugin.
