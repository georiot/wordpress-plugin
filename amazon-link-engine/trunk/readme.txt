...
conversions. In addition, signup for a GeoRiot account to get access to Advanced Reporting metrics, as well as the ability to attach your affiliate parameters to ensure that you earn the international affiliate commissions that you deserve.
...
To earn affiliate commissions, you first need to [create a GeoRiot account](http://www.georiot.com/wordpress-plugin/sign-up), and connect it to your plugin (detailed instructions can be found in the [FAQ](https://wordpress.org/plugins/amazon-link-engine/faq/)). *Note: The Amazon Link Engine WordPress plugin is completely free to use. However, if you want to take advantage of the affiliate ID management, and in-depth reporting, you can sign up for GeoRiot and try it out for free for 30 days.* 

Next, add and manage your affiliate tracking parameters for each of the Amazon Associates programs you’ve signed up for within the GeoRiot Dashboard. Once your parameters are added, the Amazon Link Engine will automatically add the correct affiliate ID per country for each click.

*Note:* You are NOT required to create a GeoRiot account, nor add your affiliate parameters to use this plugin. If you’re only interested in giving your international readers a better experience, this plugin can still be used to make sure each click gets redirected to their local storefront.
...
1.  If you haven’t already, sign up for the [Amazon Associates programs](http://associates.amazon.com) you’d like to earn commissions from (instructions on how to sign up can be found on [our site](http://support.georiot.com/support/solutions/articles/3000013792-how-to-sign-up-for-the-amazon-associates)).
...
No, you do NOT need a GeoRiot account to use the Amazon Link Engine plugin.  As soon as you install and activate the free plugin, all of your links will be automatically localized, and your customers will be routed to the product in their local storefront.  However, if you want to add your affiliate parameters, you will need a GeoRiot account.
...
1.     If you do not have a GeoRiot account, [create an account](http://www.georiot.com/wordpress-plugin/sign-up).
...
However, if you would like access to advanced reporting features and be able to affiliate all of your links, you will need to sign up for a GeoRiot account.  Try it out for [free for 30 days](http://www.georiot.com/wordpress-plugin/sign-up).  
...
1. Add your Amazon Affiliate parameters to your GeoRiot dashboard. Instructions on how to do this can be found [here](http://support.georiot.com/support/solutions/articles/71867-add-existing-affiliate).
